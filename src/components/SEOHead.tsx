...
const SEOHead = () => {
  return (
    <Helmet>
      <title>Professional Garage Door Services</title>
      ...
      <meta property="og:title" content="Garage Door - Professional Garage Door Services" />
      ...
      <meta property="twitter:title" content="Garage Door - Professional Garage Door Services" />
