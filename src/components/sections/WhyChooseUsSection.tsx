          ...
          <div className="animate-fade-in">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">Reliable & Professional loreamipsum contary Boldman Great Services</h3>
              ...
              <div className="flex items-start gap-4">
                <div className="w-6 h-6 bg-cyan-400 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Fast Same-Day Repairs</h3>
              ...
              <div className="flex items-start gap-4">
                <div className="w-6 h-6 bg-cyan-400 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Transparent Pricing — No Surprise Fees</h3>
              ...
              <div className="flex items-start gap-4">
                <div className="w-6 h-6 bg-cyan-400 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Top-Rated on Google, Yelp & Nextdoor</h3>
              ...
              <div className="flex items-start gap-4">
                <div className="w-6 h-6 bg-cyan-400 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Fully Insured & Certified Technicians</h3>
                  {/* <p className="text-gray-300">No hidden fees or surprise charges. We provide upfront, honest pricing for all services.</p> */}
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-6 h-6 bg-cyan-400 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  <h3 className="text-xl font-semibold mb-2">Honest Advice, No Upselling</h3>
                  {/* <p className="text-gray-300">No hidden fees or surprise charges. We provide upfront, honest pricing for all services.</p> */}
                </div>
              </div>
            </div>
